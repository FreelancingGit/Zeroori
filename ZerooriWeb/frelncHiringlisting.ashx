<%@ WebHandler Language="C#" Class="frelncHiringlisting" %>
...
public class frelncHiringlisting : IHttpHandler
{
    #region Properties
    ...
    private void doLoad()
    {
        ...
        if (Key != "")
        {
            ...
            {
                ZA3650LD UserFltr = JsonToObject<ZA3650LD>(JsonData);
                ZA3650LD UserVew = new ZA3650LD();

                Mode = "LI";
                ZA3680M UserPrflM = new ZA3680M();
                UserVew = UserPrflM.DoLoadFrelncList(UserFltr, Mode);
                this.Context.Response.Write(ObjectToJson(UserVew));
            }
