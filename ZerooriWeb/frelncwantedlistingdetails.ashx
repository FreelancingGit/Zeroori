<%@ WebHandler Language="C#" Class="jobswantedlistingdetails" %>
...
public class jobswantedlistingdetails : IHttpHandler
{
    #region Properties
    ...
    private void doLoad()
    {
        ...
        if (Key != "")
        {
            ...
            {
                ZA3631RPD UserFltr = JsonToObject<ZA3631RPD>(JsonData);
                ZA3631RPD UserVew = new ZA3631RPD();

                Mode = "LO";
                ZA3671M UserPrflM = new ZA3671M();
                UserVew = UserPrflM.DoLoad(UserFltr, Mode);
                this.Context.Response.Write(ObjectToJson(UserVew));
            }
            ...
            else if (Key == "CLoadData")
            {
                ...
                Mode = "CLD";
                ZA3631RPM UserPrflM = new ZA3631RPM();
                UserVew = UserPrflM.DoLoad(UserFltr, Mode);
                this.Context.Response.Write(ObjectToJson(UserVew));
            }
            else if (Key == "SignOut")
