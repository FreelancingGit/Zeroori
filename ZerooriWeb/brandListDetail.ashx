<%@ WebHandler Language="C#" Class="brandListDetail" %>
...
public class brandListDetail : IHttpHandler
{
    #region Properties
    ...
    private void doLoad()
    {
        ...
        if (Key != "")
        {
            ...
            {
                ZA3011LD UserFltr = JsonToObject<ZA3011LD>(JsonData);
                ZA3011LD UserVew = new ZA3011LD();

                Mode = "LB";
                ZA3011M UserPrflM = new ZA3011M();
                UserVew = UserPrflM.DoLoadBrand(UserFltr, Mode);
                this.Context.Response.Write(ObjectToJson(UserVew));
            }
