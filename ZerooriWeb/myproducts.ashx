<%@ WebHandler Language="C#" Class="myproducts" %>
...
public class myproducts : IHttpHandler
{
    #region Properties
    ...
    private void doLoad()
    {
        ...
        if (Key != "")
        {
            ...
            if (Key == "Init")
            {
                ZA3240D UserFltr = JsonToObject<ZA3240D>(JsonData);
                ZA3240LD UserVew = new ZA3240LD();
