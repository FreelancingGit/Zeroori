<%@ WebHandler Language="C#" Class="DrectoryList" %>
...
public class DrectoryList : IHttpHandler
{
    #region Properties
    ...
    private void doLoad()
    {
        ...
        if (Key != "")
        {
            ...
            {
                ZA3661D UserFltr = JsonToObject<ZA3661D>(JsonData);
                ZA3661LD UserVew = new ZA3661LD();
