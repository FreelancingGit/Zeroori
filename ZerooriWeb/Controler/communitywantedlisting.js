angular.module("ZerooriApp", ['ngCookies']).controller("communitywantedlisting", function ($scope, $http, $cookies) {

    $scope.urlArray = window.location.href.slice(window.location.href.indexOf('?') + 1).split('&');
    $scope.Page = 'community-wanted-listing';
    ...
    $scope.ShowItemDetail = function (EmpjobmastId) {
        ...
        $scope.navigate("jobs-wanted-listing-detail");
    }
