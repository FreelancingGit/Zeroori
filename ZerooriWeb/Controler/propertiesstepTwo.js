angular.module("ZerooriApp", ['ngCookies']).controller("propertiesstepTwo", function ($scope, $http, $cookies) {
    ...
    $http({
        ...
        if ($scope.isValidSave(response)) {
            ...
            $scope.ViewData.ZaBase.PKID = $cookies.get('PRID');
            $scope.SelectedData.PropADMastID = $cookies.get('PRID');
            ...
            try {
                $http({
                    ...
                    if ($scope.isValidSave(response) && response.data.UserData.ZaBase.SessionId != "") {
                        ...
                        if (response.data.SelectedData.BathRoom.PropSpecDtlId != null ||
                            response.data.SelectedData.BathRoom.PropSpecDtlId != undefined) {

                            $scope.SelectedData.Bedroom = response.data.SelectedData.Bedroom;
                            $scope.SelectedData.BathRoom = response.data.SelectedData.BathRoom;
                            $scope.SelectedData.Size = response.data.SelectedData.Size;
                            $scope.SelectedData.Furnished = response.data.SelectedData.Furnished;
                            $scope.SelectedData.ApartmentFor = response.data.SelectedData.ApartmentFor;
                            $scope.SelectedData.RentIsPaid = response.data.SelectedData.RentIsPaid;
                            $scope.SelectedData.ListedBy = response.data.SelectedData.ListedBy;
                            $scope.SelectedData.Category = response.data.SelectedData.Category;
            ...
            if ($scope.isValidData()) {
                ...
                $http({
                    ...
                    if ($scope.isValidSave(response) && response.data.UserData.ZaBase.SessionId != "") {
                        ...
                        $cookies.put('POID', response.data.PropADMastID);
