angular.module("ZerooriApp", ['ngCookies']).controller("myAdds", function ($scope, $http, $cookies) {
        ...
        try {
            $http({
                ...
                if ($scope.isValidSave(response)) {
                    ...
                    $scope.SelectedData.MotorsCount = response.data.MotorsCount;
                    $scope.SelectedData.PropertiesCount = response.data.PropertiesCount;
                    $scope.SelectedData.ClasiifiedsCount = response.data.ClasiifiedsCount;
                    $scope.SelectedData.JobCount = response.data.JobCountJW + response.data.JobCountJH + response.data.JobCountFW + response.data.JobCountFH;
