angular.module("ZerooriApp", ['ngCookies']).controller("directorylist", function ($scope, $http, $cookies) {
    ...
    $scope.ShowItemDetail = function (DirDtlId) {

        $cookies.put("DIRID", DirDtlId);
        $scope.navigate("directorylistdetail");
    }
