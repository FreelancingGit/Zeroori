angular.module("ZerooriApp", ['ngCookies']).controller("motorosstepthree", function ($scope, $http, $cookies) {
    ...
    $http({
        ...
        if ($scope.isValidSave(response)) {
            ...
            $scope.ViewData.AddMotorsADMastID = $cookies.get('MI');
            $scope.ViewData.UserData.ZaBase.PKID = $cookies.get('MOID');
            ...
            $http({
                ...
                if ($scope.isValidSave(response)) {
                    ...
                    if (response.data.Price != null ||
                        ...
                        $scope.ViewData.Doors = response.data.SelectedData.Doors;
