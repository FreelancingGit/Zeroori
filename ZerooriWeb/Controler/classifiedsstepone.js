angular.module("ZerooriApp", ['ngCookies']).controller("classifiedsstepone", function ($scope, $http, $cookies) {
    ...
    $scope.SetSaveData = function (response) {
        $scope.SelectedData.ClasifdADMastID = response.data.SelectedData.ClasifdADMastID;
        ...
        $scope.SelectedData.Age = response.data.SelectedData.Age;
        $scope.SelectedData.Usage = response.data.SelectedData.Usage;
    ...
    $http({
        ...
        if ($scope.isValidSave(response)) {
            ...
            $scope.ViewData.ZaBase.PKID = $cookies.get('CFID');
            $scope.SelectedData.ClasifdADMastID = $cookies.get('CFID');
            ...
            try {
                $http({
                    ...
                    if ($scope.isValidSave(response) && response.data.UserData.ZaBase.SessionId != "") {
                        ...
                        if (response.data.SelectedData.ClasifdADMastID != undefined)
            ...
            if ($scope.isValidData()) {
                ...
                $http({
                    ...
                    if ($scope.isValidSave(response) && response.data.UserData.ZaBase.SessionId != "") {
                        $cookies.remove($scope.ZaKey);
                        $cookies.put($scope.ZaKey, $scope.SessionId);
                        $cookies.put('FlC', response.data.ClasifdADMastID);
