...
namespace ZerooriBO
{
    ...
    /// User Creation
    /// </summary>
    public class ZA3621M
    {
        public ZA3621SD DoLoad(ZA3621SD FilterData, String Mode)
        {
            ...
            try
            {
                XDocument doc = new XDocument(new XElement("Root",
                    ...
                    new XElement("ai_clasifd_ad_mast_id", FilterData.UserData.ZaBase.PKID)
                ));

                String XString = doc.ToString();
                PLABSM.DAL dbObj = new PLABSM.DAL();
                dbObj.ConnectionMode = PLABSM.ConnectionModes.WebDB;
                DataSet ds = dbObj.SelectSP("ZA3621_sel", XString, PLABSM.DbProvider.MSSql);
        ...
        public ZA3621SD DoSave(ZA3621SD FilterData, String Mode)
        {
            ZA3621SD SignUpV = new ZA3621SD();
