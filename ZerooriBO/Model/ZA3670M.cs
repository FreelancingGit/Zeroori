    ...
    public class ZA3670M
    {
        public ZA3630LD DoLoad(ZA3630SD FilterData, String Mode)
        {
            ...
            try
            {
                ...
                new XElement("ai_frelnc_emp_job_mast_id", FilterData.UserData.ZaBase.PKID)
        ...
        public ZA3630RPD DoLoadFrelncList(ZA3630RPD FilterData, String Mode)
        {
            ...
            try
            {
                ...
                new XElement("ai_pageno", FilterData.PageNo),
                 new XElement("ai_frelnc_emp_job_mast_id", "")
                ));
        ...
        public ZA3630SD DoSave(ZA3630SD SaveData, String Mode, long FileLength)
        {
            ...
            try
            {
                ...
                PLABSM.DAL dbObj = new PLABSM.DAL();
                dbObj.ConnectionMode = PLABSM.ConnectionModes.WebDB;
                DataSet ds = dbObj.SelectSP("ZA3670_IU", XString, PLABSM.DbProvider.MSSql);
